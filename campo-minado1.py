...
def mostrar_como_jogar():
    ...
    print()
    print(ESCONDIDO, "= Área não explorada")
    print(TOCA, "= Toca segura")
    print(LOBO_VISIVEL, "= Lobo encontrado")
...
def mostrar_borda(inicio, meio, fim):
    print("     " + inicio, end="")

    for coluna in range(TAMANHO):
        # Cada casa tem quatro espaços de largura.
        print("────", end="")
...
def mostrar_floresta(floresta):
    ...
    for coluna in range(1, TAMANHO + 1):
        # O número 10 precisa de um espaço a menos que os números de 1 a 9.
        if coluna < 10:
    ...
    for linha in range(TAMANHO):
        if linha + 1 < 10:
            print("  " + str(linha + 1) + "  │", end="")
        else:
            print(" " + str(linha + 1) + "  │", end="")

        for coluna in range(TAMANHO):
            valor = floresta[linha][coluna]

            # No seu terminal, a árvore e o lobo ocupam dois espaços.
            if valor == ESCONDIDO or valor == LOBO_VISIVEL:
                print(" " + valor + " │", end="")
            else:
                # A toca e os números ocupam um, então recebem outro espaço.
                print(" " + str(valor) + "  │", end="")
    ...
    print("     " + ESCONDIDO + " = Área não explorada")
    print("     " + TOCA + " = Toca segura")
    print("     " + LOBO_VISIVEL + " = Lobo")
    print("     1-8 = Lobos próximos")
    print()
